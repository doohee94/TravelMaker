								...
								<div class="form">
									<form class="form-validate form-horizontal" action="insertstemp.tm" id="feedback_form" method="post">
										...
										<div class="form-group ">
											...
											<div class="col-lg-6">
												<input class="form-control " id="partnerName" type="text" name="partnerName" required />
											</div>
										</div>
										<div class="form-group ">
											<label for="adTitle" class="control-label col-lg-2">주소</label>
											<div class="col-lg-6">
												<input class="form-control " id="partnerAddr" type="text" name="partnerAddr" required />
											</div>
										</div>
										<div class="form-group">
