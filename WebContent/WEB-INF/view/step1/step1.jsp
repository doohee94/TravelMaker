...
<body>
	...
	<div class="container" id="container">
		...
		<div class="prevnextbtn">
			<center>
				<input type="button" value="< 메인" class="nextbtnmain"
					...
					onclick="location.href='/step2/step2.tm'">
			</center>
		</div>
			...
			<div id="menu2" class="tab-pane fade">
				...
				<div class="wrap">
					...
					<div class="city2">
						...
						<input type="button" value="전라남도▽" class="Jeollanamdo2"> <input
							type="button" value="전라북도▽" class="Jeollabukdo2"> <input
							type="button" value="제주" id="myButton2" class="b"> <input
							type="button" value="충청남도▽" class="Chungcheongnamdo2"> <input
							type="button" value="충청북도▽" class="Chungcheongbukdo2">
			...
			<div id="menu3" class="tab-pane fade ">
				<div class="wrap">
					...
					<div class="city2">
						...
						<input type="button" value="전라남도▽" class="Jeollanamdo3"> <input
							type="button" value="전라북도▽" class="Jeollabukdo3"> <input
							type="button" value="제주" id="myButton2" class="c"> <input
							type="button" value="충청남도▽" class="Chungcheongnamdo3"> <input
							type="button" value="충청북도▽" class="Chungcheongbukdo3">
		...
		<hr>
		<form class="contnsubform" action="step1fellow.tm" method='get'	id="infofrm">
			...
			<!-- Modal -->
			<!-- 동행자 버튼 클릭시 나오는 화면 , 
			data-backdrop="static"은 모달창 외부영역 눌러도 모달창이 닫히지 않도록 해준다.-->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="input-group">
								<input name="modalsearchplace" id="modalsearchplace" type="text"
									class="form-control" placeholder="Search ID.."> <span
						...
						<div class="modal-footer">
							<button type="button" class="ftrsbtn" id="ftrsbtn">목록초기화</button>
