...
<br/>
				...
				<div class="form-group ">
                    <input class="form-control" type="password" name="userPw" id="userPw" value="1111" placeholder="비밀번호" required="required">
                </div>
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="userName" id="userName" value="홍길동" placeholder="이름" required="required">
                </div>
                
                <div class="form-group">
                    <input class="form-control" type="text" name="userNick" id="userNick" value="홍홍홍" placeholder="닉네임" required="required">
                	
                </div>
                
                <!-- ****전화번호 하나하나 나누기**** -->
                <div class="form-group">
                    <input class="form-control" type="text" name="userTel" id="userTel" value="010-7254-4218" placeholder="전화번호" required="required">
                </div>
                
                <div class="form-group">
                    <input class="form-control" type="text" name="userEmail" id="userEmail" value="hong90@naver.com" placeholder="이메일" required="required">
                </div>
                <!-- ****플러스누르면 추가되게**** -->
